...
export default function EditProjectPage() {
  ...
  const { projects: movieProjects, mutate: refreshProjects } = useMovieProjects();
    ...
    try {
      ...
      if (response.status === 200 && response.data.success) {
        ...
        if (projectData.project_type !== "Movie") {
          ...
          router.push('/Sound-Engineer/Projects/Movie');
          return;
        }
  ...
  if (!project) {
    return (
      <div className="flex flex-col items-center justify-center min-h-screen">
        ...
        <button
          onClick={() => router.push('/Sound-Engineer/Projects/Movie')}
  ...
  return (
    ...
    >
      <div className="mb-6">
        ...
        >
          <FiArrowLeft />
          <span>Back to Movie Projects</span>
        </button>

        <h1 className="text-2xl font-bold mb-2 text-gray-800">Edit Movie Project: {project.name}</h1>
        <p className="text-gray-500">Make changes to your movie project details</p>
      </div>
