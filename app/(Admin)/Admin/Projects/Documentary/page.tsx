...
export default function ProjectsPage() {
  ...
  const { projects: documentaryProjects, error, isLoading, mutate: refreshProjects } = useDocumentaryProjects();

  useEffect(() => {
    if (documentaryProjects) {
      // Extract unique channels from documentary projects
      ...
      console.log('Available channels from Documentary projects:', uniqueChannels);
