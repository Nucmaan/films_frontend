...
export default function SoundEndPage() {
    ...
    return (
      <div className="flex items-center justify-center min-h-screen bg-gray-50">
        <div className="flex flex-col items-center gap-4">
          ...
          <div className="text-lg font-medium text-gray-700">Loading sound engineer details...</div>
        </div>
      </div>
    );
  }
  ...
  const totalSpentTime = tasks.reduce((sum, task) => sum + task.time_spent, 0);
  ...
  // Get assignee name from first task (they should all be the same)
  const assigneeName = tasks.length > 0 ? tasks[0].assignedTo_name : `Employee #${id}`;
        ...
        <div className="container mx-auto px-6 py-4">
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              <Link href="/Admin/Sound-End" className="p-3 bg-blue-50 rounded-xl hover:bg-blue-100 transition-colors duration-200 shadow-sm hover:shadow">
                <ArrowLeft className="h-5 w-5 text-blue-600" />
              </Link>
              <div>
                <h1 className="text-2xl font-bold text-gray-900 tracking-tight">
                  {assigneeName} - Task Overview
                </h1>
                <p className="text-sm text-gray-500 mt-1">Sound engineering task details and performance</p>
              </div>
            </div>
                ...
                <div className="bg-gradient-to-br from-blue-500 to-indigo-600 p-6 text-white">
                  <div className="flex flex-col items-center text-center gap-4">
                    ...
                    <div className="space-y-1">
                      <h2 className="text-xl font-bold">{assigneeName}</h2>
                      <p className="text-sm text-blue-100">Sound Engineer</p>
                    </div>
                  </div>
                </div>
              ...
              <CardContent className="p-0">
                <div className="flex items-stretch h-full">
                  ...
                  <div className="p-6 flex-1">
                    ...
                    <div className="mt-4 flex items-end gap-2">
                      <div className="text-3xl font-bold text-gray-900">{totalSpentTime.toFixed(1)}</div>
          ...
          <Card className="border border-gray-100 bg-white rounded-2xl overflow-hidden shadow-sm hover:shadow-md transition-all">
            <CardHeader className="border-b border-gray-100 py-5 px-6">
              <div className="flex items-center gap-3">
                ...
                <div>
                  <CardTitle className="text-lg font-semibold">Task Recording Details</CardTitle>
                ...
                <div className="text-center py-16 bg-gray-50/20">
                  <div className="flex flex-col items-center gap-4">
                    ...
                    <div className="space-y-1 text-center">
                      ...
                      <p className="text-sm text-gray-500">This sound engineer has no assigned tasks</p>
                    </div>
                  </div>
                </div>
              ) : (
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-gray-50/80 hover:bg-gray-50/80">
                        ...
                        <TableHead className="font-semibold text-gray-600">Assigner</TableHead>
                      </TableRow>
                    </TableHeader>
                    <TableBody>
                          ...
                          >
                            ...
                            <TableCell>
                              <div className="flex items-center gap-1.5">
                                ...
                                <span className="font-medium">{task.time_spent} hrs</span>
                              </div>
                            </TableCell>
                            <TableCell className="font-medium">{task.assignedTo_name}</TableCell>
                          </TableRow>
                        );
                      })}
                    </TableBody>
                    <TableFooter className="bg-gray-50/80">
                      <TableRow>
                        ...
                        <TableCell className="font-semibold text-gray-700">{totalHours.toFixed(1)} hrs</TableCell>
                        <TableCell className="font-semibold text-gray-700">{totalSpentTime.toFixed(1)} hrs</TableCell>
                        <TableCell className="font-semibold text-blue-700">${totalCommission.toFixed(2)}</TableCell>
                      </TableRow>
                    </TableFooter>
                  </Table>
                </div>
