          ...
          <div className="flex items-center justify-between">
            <div className="flex items-center gap-4">
              ...
              <div>
                ...
                <p className="text-sm text-gray-500 mt-1">Users with completed tasks performance</p>
              </div>
            </div>
            ...
            <CardHeader className="border-b border-gray-100 py-5 px-6">
              <div className="flex items-center justify-between">
                <div className="flex items-center gap-3">
                  ...
                  <div>
                    <CardTitle className="text-lg font-semibold">Users - Completed Tasks</CardTitle>
                  ...
                  <Table>
                    <TableHeader>
                      <TableRow className="bg-gray-50/80 hover:bg-gray-50/80">
                        <TableHead className="font-semibold text-gray-600">Emp ID</TableHead>
                        <TableHead className="font-semibold text-gray-600">Name</TableHead>
                        <TableHead className="font-semibold text-gray-600">Exp Level</TableHead>
                        ...
                        <TableHead className="font-semibold text-gray-600">Completed Count</TableHead>
                    ...
                    <TableBody>
                      {filteredRows.map((user, index) => {
                        const commission = (user.total_estimated_hours * 5).toFixed(2);
                        return (
                                                     <TableRow key={user.assignedTo_empId} className="hover:bg-blue-50/5 transition-colors duration-150 group border-b border-gray-100">
                             <TableCell className="font-medium">{user.assignedTo_empId}</TableCell>
                             ...
                             <TableCell className="text-right">
                              <Link href={`/Admin/Reports-Analytics/${user.assignedTo_empId}`}>
                                <button 
