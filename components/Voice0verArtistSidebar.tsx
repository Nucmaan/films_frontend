...
interface VoiceoverArtistSidebarProps {
  open?: boolean;
}

export default function Voice0verArtistSidebar({ open = true }: VoiceoverArtistSidebarProps) {
  ...
  const mainMenuItems = [
    ...
    { path: "/Voice-over-Artist/assignedTasks", icon: ClipboardCheck, label: "Assigned Tasks" },
  ];
